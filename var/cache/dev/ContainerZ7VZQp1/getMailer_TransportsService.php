...
<<<<<<<< HEAD:var/cache/dev/ContainerXT7JE5o/getMailer_TransportsService.php
namespace ContainerXT7JE5o;
========
namespace ContainerZ7VZQp1;
>>>>>>>> d4de6d14 (Correction AboutUs):var/cache/dev/ContainerZ7VZQp1/getMailer_TransportsService.php
...
class getMailer_TransportsService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['mailer.transports'] = (new \Symfony\Component\Mailer\Transport(new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['mailer.transport_factory.brevo'] ?? $container->load('getMailer_TransportFactory_BrevoService'));
