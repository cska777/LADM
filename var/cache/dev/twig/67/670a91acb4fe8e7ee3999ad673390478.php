...
class __TwigTemplate_30ee266ace43ab1a19f2874349bb9f6c extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"adTable table-responsive-sm d-flex justify-content-center\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["user"]) {
            ...
            yield "                <tr class=\"\">
                    <td>";
            // line 17
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["user"], "nom", [], "any", false, false, false, 17), "html", null, true);
            yield "</td>
                    <td>";
            // line 18
            ...
            yield "</td>
                    <td>";
            // line 19
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["user"], "type", [], "any", false, false, false, 19), "html", null, true);
            yield "</td>
                    <td>";
            // line 20
            $context['_parent'] = $context;
            ...
            // line 30
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_user_edit", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["user"], "id", [], "any", false, false, false, 30)]), "html", null, true);
            yield "\">
                        ...
                        <form action=\"";
            // line 39
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_user_delete", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["user"], "id", [], "any", false, false, false, 39)]), "html", null, true);
            yield "\" method=\"post\" onsubmit=\"return confirm('Êtes-vous sur de vouloir supprimer votre compte ?')\";>
                            <input type=\"hidden\" name=\"_token\" value=\"";
            // line 40
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderCsrfToken(("delete" . CoreExtension::getAttribute($this->env, $this->source, $context["user"], "id", [], "any", false, false, false, 40))), "html", null, true);
            yield "\">
...
", "user/tabBord.html.twig", "/Users/davidsat/Desktop/LADM/templates/user/tabBord.html.twig");
    }
}
