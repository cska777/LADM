...
class __TwigTemplate_b975351526a0591c84f42f238b5766a7 extends Template
{
    private $source;
    private $macros = [];
    ...
    <input type=\"hidden\" name=\"_token\" value=\"";
        // line 2
        yield Twig\Extension\EscaperExtension::escape($this->env, $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderCsrfToken(("delete" . CoreExtension::getAttribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 2, $this->source); })()), "id", [], "any", false, false, false, 2))), "html", null, true);
        yield "\">
...
", "user/_delete_form.html.twig", "/Users/dvpt/Desktop/ong2/templates/user/_delete_form.html.twig");
    }
}
