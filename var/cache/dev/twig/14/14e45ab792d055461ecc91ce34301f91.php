...
class __TwigTemplate_aabc9480646386b55d7c514d78c862ea extends Template
{
    private $source;
    private $macros = [];
...
<head>
    <title>";
        // line 4
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["subject"]) || array_key_exists("subject", $context) ? $context["subject"] : (function () { throw new RuntimeError('Variable "subject" does not exist.', 4, $this->source); })()), "html", null, true);
        yield "</title>
</head>
<body>
    <h3>";
