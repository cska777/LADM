...
/* don/index.html.twig */
class __TwigTemplate_e1a8c35c46a139f8a755d10c8b5fdc3b extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t<label for=\"mastercard\"><img src=\"";
        // line 135
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("styles/img/logo/mastercard-logo.png"), "html", null, true);
...
\t\t\t\t\t\t\t<label for=\"visa\"><img src=\"";
        // line 139
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("styles/img/logo/Visa-Logo.png"), "html", null, true);
...
\t\t\t\t\t\t\t<label for=\"cb\"><img src=\"";
        // line 143
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("styles/img/logo/logo-cb.jpg"), "html", null, true);
...
";
    ...
    {
        return array (  306 => 189,  257 => 143,  250 => 139,  243 => 135,  228 => 122,  121 => 14,  112 => 12,  107 => 11,  98 => 9,  94 => 8,  91 => 7,  81 => 6,  60 => 3,  37 => 1,);
    }
...
\t\t<div id=\"donation-message\" class=\"alert alert-success\">{{ message }}</div>
\t{% endfor %}
\t{% for message in app.flashes('error') %}
\t\t<div id=\"donation-message\" class=\"alert alert-danger\">{{ message }}</div>
\t{% endfor %}
\t</div>
...
\t\t\t\t\t\t<div class=\"d-flex moyenPaiementDivDon mt-3 justify-content-center\">
\t\t\t\t\t\t\t<div
\t\t\t\t\t\t\t\tclass=\"text-center moyenSousDivDon\">{# <button class=\"btnMoyenDon\">
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<i class=\"fa-solid fa-money-check\"></i><br><p>Faire un don par chèque</p>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</button> #}
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t<div class=\"text-center moyenSousDivDon\">
\t\t\t\t\t\t\t\t<button class=\"btnMoyenDon\">
...
\t\t\t\t\t<section class=\"d-flex\" id=\"sectionVMCDon\">
\t\t\t\t\t\t<div class=\"\">
\t\t\t\t\t\t\t<label for=\"mastercard\"><img src=\"{{asset(\"styles/img/logo/mastercard-logo.png\")}}\" alt=\"log mastercard\"></label><br>
\t\t\t\t\t\t\t<input type=\"radio\" name=\"methodePaiement\" id=\"mastercardRadio\">
\t\t\t\t\t\t</div>
\t\t\t\t\t\t<div class=\"\">
\t\t\t\t\t\t\t<label for=\"visa\"><img src=\"{{asset(\"styles/img/logo/Visa-Logo.png\")}}\" alt=\"logo visa\"></label><br>
\t\t\t\t\t\t\t<input type=\"radio\" name=\"methodePaiement\" id=\"visaRadio\">
\t\t\t\t\t\t</div>
\t\t\t\t\t\t<div class=\"\">
\t\t\t\t\t\t\t<label for=\"cb\"><img src=\"{{asset(\"styles/img/logo/logo-cb.jpg\")}}\" alt=\"logo cb\"></label><br>
\t\t\t\t\t\t\t<input type=\"radio\" name=\"methodePaiement\" id=\"cbRadio\">
\t\t\t\t\t\t</div>
\t\t\t\t\t</section>
...
\t\t\t\t<div class=\"bodyDonMateriel\">
\t\t\t\t\t<p>Entrez vos informations, nous vous contacterons pour un don matériel.</p>
\t\t\t\t\t<form method=\"POST\" action=\"{{ path('app_don_save') }}\" id=\"donForm\">
\t\t\t\t\t<select name=\"civiliteDonMateriel\" class=\"civiliteDonMateriel\" required>
\t\t\t\t\t\t<option value=\"\" disabled>Civilité *</option>
\t\t\t\t\t\t<option value=\"m\">M</option>
\t\t\t\t\t\t<option value=\"mme\">Mme</option>
...
{% endblock %}
", "don/index.html.twig", "/Users/dvpt/Desktop/ong2/templates/don/index.html.twig");
    }
}
