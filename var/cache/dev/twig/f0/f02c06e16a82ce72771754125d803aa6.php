...
/* newz/edit.html.twig */
class __TwigTemplate_91828cdb53e2fc71b66817c3f7443836 extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"container w-75 \">
    <div class=\"profil my-5\" id=\"formPersPhy\">
     ";
        ...
        <div class=\"champ d-flex justify-content-between\">
                ";
        // line 12
        ...
        if (CoreExtension::getAttribute($this->env, $this->source, (isset($context["newz"]) || array_key_exists("newz", $context) ? $context["newz"] : (function () { throw new RuntimeError('Variable "newz" does not exist.', 21, $this->source); })()), "image", [], "any", false, false, false, 21)) {
            ...
            yield "            <div class=\"form-group ms-1 mb-3\">
                ...
                <img src=\"";
            // line 24
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(("upload/" . CoreExtension::getAttribute($this->env, $this->source, (isset($context["newz"]) || array_key_exists("newz", $context) ? $context["newz"] : (function () { throw new RuntimeError('Variable "newz" does not exist.', 24, $this->source); })()), "image", [], "any", false, false, false, 24))), "html", null, true);
        ...
        ";
        // line 30
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 30, $this->source); })()), "contenu", [], "any", false, false, false, 30), 'row');
        yield "
    </div>
    ...
    ";
        ...
        // line 35
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_newz_delete", ["id" => CoreExtension::getAttribute($this->env, $this->source, (isset($context["newz"]) || array_key_exists("newz", $context) ? $context["newz"] : (function () { throw new RuntimeError('Variable "newz" does not exist.', 35, $this->source); })()), "id", [], "any", false, false, false, 35)]), "html", null, true);
        yield "\" onsubmit=\"return confirm('Êtes-vous sur de vouloir supprimer votre compte ?');\">
                <input type=\"hidden\" name=\"_token\" value=\"";
        // line 36
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderCsrfToken(("delete" . CoreExtension::getAttribute($this->env, $this->source, (isset($context["newz"]) || array_key_exists("newz", $context) ? $context["newz"] : (function () { throw new RuntimeError('Variable "newz" does not exist.', 36, $this->source); })()), "id", [], "any", false, false, false, 36))), "html", null, true);
        yield "\">
...
";
    ...
    {
        return array (  157 => 36,  153 => 35,  149 => 34,  142 => 30,  137 => 28,  134 => 27,  128 => 24,  124 => 22,  122 => 21,  117 => 19,  111 => 16,  106 => 14,  101 => 12,  95 => 9,  90 => 6,  80 => 5,  60 => 3,  37 => 1,);
    }
...
{% endblock %}
", "newz/edit.html.twig", "/Users/davidsat/Desktop/LADM/templates/newz/edit.html.twig");
    }
}
