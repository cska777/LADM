...
class __TwigTemplate_1f2aa8c0dc278d988bec5db9f993b29a extends Template
{
    private $source;
    private $macros = [];
    ...
    <a href=\"";
        // line 5
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["url"]) || array_key_exists("url", $context) ? $context["url"] : (function () { throw new RuntimeError('Variable "url" does not exist.', 5, $this->source); })()), "html", null, true);
...
", "reset_password/email.html.twig", "/Users/davidsat/Desktop/LADM/templates/reset_password/email.html.twig");
    }
}
