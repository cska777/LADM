...
class __TwigTemplate_fa2984be0856713e7d23a05540081184 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"carousel-inner\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["newz"]) {
            ...
            // line 5
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(("upload/" . CoreExtension::getAttribute($this->env, $this->source, $context["newz"], "image", [], "any", false, false, false, 5))), "html", null, true);
            yield "\" alt=\"";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["newz"], "titre", [], "any", false, false, false, 5), "html", null, true);
            yield "\">
...
", "home/carousel.html.twig", "/Users/davidsat/Desktop/LADM/templates/home/carousel.html.twig");
    }
}
