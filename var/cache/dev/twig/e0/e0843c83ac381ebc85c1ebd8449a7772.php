...
class __TwigTemplate_8128d07b62195af71b9a659733c7d7de extends Template
{
    private $source;
    private $macros = [];
...
(isset($context["messageType"]) || array_key_exists("messageType", $context) ? $context["messageType"] : (function () { throw new RuntimeError('Variable "messageType" does not exist.', 16, $this->source); })()) == "info")) {
        ...
        yield "                <div class=\"card-body\">
                    <p>";
        // line 20
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["message"]) || array_key_exists("message", $context) ? $context["message"] : (function () { throw new RuntimeError('Variable "message" does not exist.', 20, $this->source); })()), "html", null, true);
        yield "</p>
                </div>
                ";
        // line 22
