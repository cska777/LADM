...
/* user/edit.html.twig */
class __TwigTemplate_b43729430971e254dd9c333805a1b9e1 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"profil my-5\">
     ";
        ...
        // line 70
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderCsrfToken(("delete" . CoreExtension::getAttribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 70, $this->source); })()), "id", [], "any", false, false, false, 70))), "html", null, true);
        yield "\">
...
{% endblock %}
", "user/edit.html.twig", "/Users/davidsat/Desktop/LADM/templates/user/edit.html.twig");
    }
}
