...
class __TwigTemplate_b2a30ca6e31bcfc5a4ac52ac89d2afbd extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t<img class=\"card-img-sm-left\" id=\"actualites-card-img\" src=\"";
            // line 47
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(("upload/" . CoreExtension::getAttribute($this->env, $this->source, $context["article"], "image", [], "any", false, false, false, 47))), "html", null, true);
            yield "\"/>
\t\t\t\t<div class=\"card-body\" id=\"actualites-card-body\">
\t\t\t\t\t<h4 class=\"card-title h5 h4-sm\">";
            // line 49
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["article"], "titre", [], "any", false, false, false, 49), "html", null, true);
            yield "</h4>
\t\t\t\t\t<p class=\"card-text\">";
            // line 50
...
\t\t\t\t\t<a href=\"";
            // line 51
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("show_article", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["article"], "id", [], "any", false, false, false, 51)]), "html", null, true);
...
", "home/actualite.html.twig", "/Users/davidsat/Desktop/LADM/templates/home/actualite.html.twig");
    }
}
