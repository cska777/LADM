...
class __TwigTemplate_40b4f2c0681421bf7ba8d6fd1c579843 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        <button class=\"btn\">";
        // line 3
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(((array_key_exists("button_label", $context)) ? (Twig\Extension\CoreExtension::default((isset($context["button_label"]) || array_key_exists("button_label", $context) ? $context["button_label"] : (function () { throw new RuntimeError('Variable "button_label" does not exist.', 3, $this->source); })()), "Valider")) : ("Valider")), "html", null, true);
        yield "</button>
";
        // line 4
...
{{ form_end(form) }}
", "user/_form.html.twig", "/Users/dvpt/Desktop/ong2/templates/user/_form.html.twig");
    }
}
