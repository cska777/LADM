 ...
 */
class Subscriber extends \App\Entity\Subscriber implements \Doctrine\ORM\Proxy\InternalProxy
{
    ...
    private const LAZY_OBJECT_PROPERTY_SCOPES = [
        ...
        "\0".parent::class."\0".'isConfirmed' => [parent::class, 'isConfirmed', null],
        "\0".parent::class."\0".'lastName' => [parent::class, 'lastName', null],
        "\0".parent::class."\0".'subscribedAt' => [parent::class, 'subscribedAt', null],
        "\0".parent::class."\0".'unsubscribeToken' => [parent::class, 'unsubscribeToken', null],
        ...
        'isConfirmed' => [parent::class, 'isConfirmed', null],
        'lastName' => [parent::class, 'lastName', null],
        'subscribedAt' => [parent::class, 'subscribedAt', null],
        'unsubscribeToken' => [parent::class, 'unsubscribeToken', null],
    ];
