 ...
 */
final class Version20240521184925 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE about_us CHANGE type type VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE about_us CHANGE type type VARCHAR(255) NOT NULL');
